...
SECRET_KEY = 'django-insecure-^!3l59ef4^znykm594!oaanmd+rfnudl6r)73lo)_maghr-it9'
...
AUTH_USER_MODEL = 'ai_sop.AdvUser'
...
TEMPL_DIR = os.path.join(BASE_DIR, 'sop', 'templates', 'sop')
